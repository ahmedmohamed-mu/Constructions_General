...
class ConstructionClientIPC(models.Model):
    ...
    previous_certificates_value = fields.Monetary(compute="_compute_amounts", currency_field="currency_id")
    cumulative_certified_value = fields.Monetary(compute="_compute_amounts", currency_field="currency_id")
